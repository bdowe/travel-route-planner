          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${response.locationCount} locations • ${response.algorithm}',
                ...
                if (response.improvementPct != null)
                  Container(
              ...
              children: [
                ...
                Expanded(
                  child: _StatCard(
                    icon: MdiIcons.car,
                    label: 'Travel',
                    value: response.totalTravelTimeFormatted,
                    color: Colors.orange,
                  ),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _StatCard(
                    ...
                    label: 'Visit',
                    value: response.totalVisitTimeFormatted,
                    color: Colors.green,
                  ),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _StatCard(
                    ...
                    label: 'Total',
                    value: response.totalTripTimeFormatted,
                    color: Colors.purple,
                  ),
                ),
              ],
              ...
              children: [
                ...
                Expanded(
                  child: ListView.builder(
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    itemCount: response.locationTimings.length,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      '${timing.arrivalTime} - ${timing.departureTime}',
                ...
                if (timing.location.category != null) ...[
                  const SizedBox(height: 4),
                  Text(
